...
export default function ResetPasswordClient() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) throw new Error(data.message || 'Échec de la réinitialisation')
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 pt-22 flex items-center justify-center">
      <div className="max-w-md w-full p-6 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            <label htmlFor="confirm-password" className="block text-gray-600">Confirmer le mot de passe</label>
            <input
              type="password"
              id="confirm-password"
              className="w-full mt-2 p-3 border border-gray-300 rounded-lg"
